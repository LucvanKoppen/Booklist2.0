...
class __TwigTemplate_9eafa265b02d616dca0a51dfc2d1cc0be92041a8b8f9f4dce3599071d102d4ab extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["book"]) {
            ...
            echo "</td>
                <td>";
            // line 23
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["book"], "ISBN", [], "any", false, false, false, 23), "html", null, true);
            echo "</td>
                <td>";
            // line 24
            ...
            echo "</td>
                <td>
                    <a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("books_show", ["id" => twig_get_attribute($this->env, $this->source, $context["book"], "id", [], "any", false, false, false, 28)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("books_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["book"], "id", [], "any", false, false, false, 29)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
    ...
    <a href=\"";
        // line 40
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("books_new");
        echo "\">Create new</a>
";
    ...
    <table class=\"table\">
        ...
        {% for book in books %}
            <tr>
                ...
                <td>{{ book.price }}</td>
                <td>
                    <a href=\"{{ path('books_show', {'id': book.id}) }}\">show</a>
...
{% endblock %}
", "books/index.html.twig", "C:\\Users\\lvkop\\PhpstormProjects\\untitled10\\Booklist\\templates\\books\\index.html.twig");
    }
}
